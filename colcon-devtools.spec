...
License  : Apache-2.0
Requires: colcon-devtools-python = %{version}-%{release}
Requires: colcon-devtools-python3 = %{version}-%{release}
...
%prep
%setup -q -n colcon-devtools-0.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571405230
